...
Noodle is a project that aims to solve one of my personal biggest frustrations with education and that's how uncapabile the tools provided are to make us the most efficient at studying and organising our lives as students a lot better. Often you are given a platform to access lecture notes, announcements and other bits and pieces of your studies but you're not given a platform to use that content.
...
When all your different content is on the same platform, you could do pretty awesome things to automatically organise and use that content, such as:
...
- Sync a notebook with a specific lecuture PDF.
- Complete todos based on actions such as marking yourself attending for a lecture.

## A bit more

I currently use Craft for note taking, Things 3 for my tasks, Fantastical for the lectures calendar and Gradeguide to calculate my current progression. It's all a bit much to organise simultaneosuly and when you have a platform that combines all these aspects then all of your content is automatically synced up, it's easier to manage because it's all there and you get the benefits that these different types of content are all together on one platform and can use each other to give you more insights and tools.
