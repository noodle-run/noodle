...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-gray-1/20 dark:bg-graydark-1/20 fixed inset-0 z-50 backdrop-blur-sm',
      className,
    )}
    {...props}
  />
